...
class ContentCategory extends Model
{
    ...
    protected $fillable = ['title','class','image','parent_id','mode','commision','color','icon','background','req_icon'];
    public $timestamps = false;

    public function contents(){
        return $this->belongsToMany('App\Models\Content','tbl_contents_category_relation','category_id','content_id');
    }
