...
@endsection
@section('page')
    <div class="login-s" style="background: url('{{{ get_option('login_page_background') }}}')">
        <div class="h-25"></div>
        <div class="h-25"></div>
        ...
        <div class="formBox level-login" dir="ltr">
            ...
            <div class="box loginBox">
                ...
                <form class="form" action="/user/dologin" method="post" id="loginForm" style="text-align: left;direction: ltr">
                    <div class="f_row">
                    ...
                    <button class="btn btn-custom pull-left btn-register-user btn-register-user-r"><span>{{{ trans('main.sign_in') }}}</span></button>
                    <div class="h-10"></div>
                    <div class="f_link">
	...
	<polygon points="199.404,81.529 74.742,81.529 127.987,28.285 99.701,0 0,99.702 99.701,199.404 127.987,171.119 74.742,117.876
		199.404,117.876 "/>
            ...
            <div class="box registerBox">
                ...
                <form class="form" method="post" action="/user/doregister" style="text-align: left">
                    <div class="f_row">
                    ...
                    <div class="f_row">
                        ...
                        <input type="password" id="r-re-password" name="repassword" valid-title="Fill out this form." class="input-field validate" required>
                        <u></u>
                    </div>
                    <div class="f_row">
