...
<section class="card">
  ...
  <div class="card">
      ...
      <div class="card-body">
        <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="name" value="{{{ $meta['name'] or '' }}}" class="form-control">
                    </div>
                    <label class="control-label ">{{{ trans('main.email') }}}</label>
                    <div class="col-md-4">
                        <input type="text" value="{{{ $meta['email'] or '' }}}" class="form-control text-left disabled" disabled>
                    </div>
                </div>
            </div>        
      </div>
    ...
    <div class="card">
        ...
        <div class="card-body">      
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <label class="control-label">{{{ trans('main.short_biography') }}}</label>
                                                    <div class="col-md-5">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <label class="control-label">{{{ trans('main.account_number') }}}</label>
                            <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="input-group"> <span class="input-group-addon view-selected img-icon-s" data-toggle="modal" data-target="#ImageModal" data-whatever="melli_card"><span class="formicon mdi mdi-eye"></span></span>
                                    <input type="text" name="melli_card" class="form-control" value="{{{ $meta['melli_card'] or '' }}}" @if(isset($userMeta[ 'seller_apply']) && $userMeta[ 'seller_apply']==1) disabled @endif> <span class="input-group-addon click-for-upload img-icon-s"><span class="formicon mdi mdi-arrow-up-thick"></span></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <h2 class="mb-0">
            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#imagesC" aria-expanded="false" aria-controls="imagesC">
            Images
            </button>
        </h2>
        </div>
    ...
    <div class="card">
        <div class="card-header" id="headingTwo">
        <h2 class="mb-0">
            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#security" aria-expanded="false" aria-controls="security">
            Postal
            </button>
        </h2>
        </div>
        ...
        <div class="row">
            ...
            <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <textarea name="address" rows="20" class="form-control">{{{ $meta['address'] or '' }}}</textarea>
                                        </div>
                                    </div>
