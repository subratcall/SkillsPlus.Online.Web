            ...
            <form action="/admin/notification/store" class="form-horizontal form-bordered" method="post">
                ...
                <div class="form-group recipent" id="users">
                    ...
                    <div class="col-md-11" dir="ltr">
                        <select name="recipent_list_users[]" multiple class="form-control select2 text-left">
                ...
                <div class="form-group @if(!isset($_GET['recipent_type']) || $_GET['recipent_type']!='userone') recipent @endif" id="userone">
                    ...
                    <div class="col-md-11">
                        <select name="recipent_list_user" class="form-control select2">
                            @foreach($users as $user)
                ...
                <div class="form-group recipent" id="category">
                    ...
                    <div class="col-md-11">
                        <select name="recipent_list_category" class="form-control select2">
