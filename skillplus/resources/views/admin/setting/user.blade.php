                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-7">
                           <select class="form-control" name="user_register_mode">
                              <option value="active" @if(isset($_setting['user_register_mode']) && $_setting['user_register_mode'] == 'active') selected @endif>{{{ trans('admin.quick_activation') }}}</option>
                              <option value="deactive" @if(isset($_setting['user_register_mode']) && $_setting['user_register_mode'] == 'deactive') selected @endif>{{{ trans('admin.email_verification') }}}</option>
                           </select>
                        </div>
                     </div>

                     @if(isset($_setting['user_register_mode']) && $_setting['user_register_mode'] == 'deactive')
                        <div class="form-group">
                           ...
                           <div class="col-md-7">
                              <select id="template" name="user_register_active_email" class="form-control">
                                 ...
                                 @foreach($template as $temp)
                                    <option value="{{{ $temp->id }}}" @if(isset($_setting['user_register_active_email']) && $temp->id == $_setting['user_register_active_email']) selected @endif>{{{ $temp->title }}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-7">
                           <select id="template" name="user_register_wellcome_email" class="form-control">
                              <option value=""></option>
                              @foreach($template as $temp)
                                 <option value="{{{ $temp->id }}}" @if(isset($_setting['user_register_wellcome_email']) && $temp->id == $_setting['user_register_wellcome_email']) selected @endif>{{{ $temp->title }}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-7">
                           <select id="template" name="user_register_reset_email" class="form-control">
                              <option value=""></option>
                              @foreach($template as $temp)
                                 <option value="{{{ $temp->id }}}" @if(isset($_setting['user_register_reset_email']) && $temp->id == $_setting['user_register_reset_email']) selected @endif>{{{ $temp->title }}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-7">
                           <select id="template" name="user_register_new_password_email" class="form-control">
                              <option value=""></option>
                              @foreach($template as $temp)
                                 <option value="{{{ $temp->id }}}" @if(isset($_setting['user_register_new_password_email']) && $temp->id == $_setting['user_register_new_password_email']) selected @endif>{{{ $temp->title }}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-7">
                           <select id="template" name="email_notification_template" class="form-control">
                              <option value=""></option>
                              @foreach($template as $temp)
                                 <option value="{{{ $temp->id }}}" @if(isset($_setting['email_notification_template']) && $temp->id == $_setting['email_notification_template']) selected @endif>{{{ $temp->title }}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
