        ...
        <div class="card-body">
            ...
            <form action="/admin/balance/edit/store/{{{ $item->id or 0 }}}" class="form-horizontal form-bordered" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input type="text" id="fdate" class="text-center form-control" value="{!! date('Y/m/d',$item->create_at) !!}" name="fdate" placeholder="Date" required>
                            <input type="hidden" id="date" name="date" value="{!! date('d-M-Y',$item->create_at) !!}">
                            <span class="input-group-addon fdatebtn" id="fdatebtn"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <input type="time" class="form-control text-center" value="{!! to_latin_num(date('H:i',$item->create_at)) !!}" name="time" required>
                    </div>
                </div>
