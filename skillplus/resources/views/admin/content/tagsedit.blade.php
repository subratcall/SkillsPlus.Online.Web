        ...
        <div class="card-body">
            <div class="tabs">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#edit" data-toggle="tab"> {{{ trans('admin.th_edit') }}} {{{ $item->tag or '' }}} </a></li>
                </ul>
                    ...
                    <div id="edit" class="tab-pane ">
                        <form method="post" action="/admin/content/category/filter/tag/store/edit" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="tag" value="{{{ $item->tag or '' }}}" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6" data-plugin-spinner data-plugin-options='{ "value":0, "min": 0, "max": 100 }'>
                                    <div class="input-group w-150">
                                        <input type="number" name="sort" value="{{{ $item->sort or 0 }}}" class="spinner-input form-control" maxlength="3" readonly>
