      ...
      <ul class="sidebar-menu">
       ...
       @if(checkAccess('report'))<li class="dropdown" id="report">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a class="nav-link" href="/admin/report/balance">{{{ trans('admin.financial_report') }}}</a>
         </li>
        </ul>
       </li>@endif
       ...
       @if(checkAccess('user'))<li class="dropdown" id="user">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a class="nav-link" href="/admin/user/seller">{{{ trans('admin.identity_verification') }}}</a>
         </li>
        </ul>
       </li>@endif
       @if(checkAccess('ticket'))<li class="dropdown" id="ticket">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-life-ring"></i>
         <span>{{{ trans('admin.support') }}}</span></a>
        <ul class="dropdown-menu">
         <li><a class="nav-link" href="/admin/ticket/tickets">{{{ trans('admin.list') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/ticket/ticketsopen">{{{ trans('admin.pending_tickets') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/ticket/ticketsclose">{{{ trans('admin.closed_tickets') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/ticket/category">{{{ trans('admin.support_departments') }}}</a>
         </li>
       ...
       @if(checkAccess('notification'))<li class="dropdown" id="notification">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-bell"></i>
         <span>{{{ trans('admin.notifications') }}}</span></a>
        <ul class="dropdown-menu">
         <li><a class="nav-link" href="/admin/notification/template">{{{ trans('admin.templates') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/notification/template/tnew">{{{ trans('admin.new_template') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/notification/list">{{{ trans('admin.sent_notifications') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/notification/new">{{{ trans('admin.new_notification') }}}</a>
         </li>
        </ul>
       </li>@endif
       ...
       @if(checkAccess('content'))<li class="dropdown" id="content">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a
           class="nav-link @if(isset($alert['content_waiting']) && $alert['content_waiting'] > 0) beep beep-sidebar @endif"
           href="/admin/content/waiting">{{{ trans('admin.pending_courses') }}}</a>
         </li>
         <li><a
           class="nav-link @if(isset($alert['content_draft']) && $alert['content_draft'] > 0) beep beep-sidebar @endif"
         ...
         <li><a class="nav-link" href="/admin/content/support">{{{ trans('admin.support_tickets') }}}</a>
         </li>
       ...
       @if(checkAccess('request'))<li class="dropdown" id="request">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a class="nav-link" href="/admin/request/record/list">{{{ trans('admin.future_courses') }}}</a>
         </li>
        </ul>
       </li>@endif
       @if(checkAccess('blog'))<li class="dropdown" id="blog">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a class="nav-link" href="/admin/blog/category">{{{ trans('admin.contents_categories') }}}</a>
         </li>
       ...
       @if(checkAccess('channel'))<li class="dropdown" id="channel">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a
           class="nav-link @if(isset($alert['channel_request']) && $alert['channel_request'] > 0) beep beep-sidebar @endif"
       ...
       @if(checkAccess('balance'))<li class="dropdown" id="balance">
        ...
        <ul class="dropdown-menu">
         <li><a class="nav-link" href="/admin/balance/list">{{{ trans('admin.financial_documents') }}}</a>
         </li>
         ...
         <li><a class="nav-link" href="/admin/balance/analyzer">{{{ trans('admin.financial_analyser') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/balance/transaction">{{{ trans('admin.transactions_report') }}}</a>
         </li>
        </ul>
       </li>@endif
       ...
       @if(checkAccess('email'))<li class="dropdown" id="email">
        ...
        <ul class="dropdown-menu">
         <li><a class="nav-link" href="/admin/email/templates">{{{ trans('admin.email_templates') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/email/template/new">{{{ trans('admin.new_template') }}}</a>
         </li>
       ...
       @if(checkAccess('discount'))<li class="dropdown" id="discount">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a class="nav-link" href="/admin/discount/contentlist">{{{ trans('admin.promotions_list') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/discount/contentnew">{{{ trans('admin.new_promotion') }}}</a>
         </li>
        </ul>
       </li>@endif
       @if(checkAccess('ads'))<li class="dropdown" id="ads">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a class="nav-link" href="/admin/ads/request">{{{ trans('admin.advertisement_requests') }}}</a>
         </li>
       ...
       @if(checkAccess('setting'))<li class="dropdown" id="setting">
        ...
        <ul class="dropdown-menu">
         ...
         <li><a class="nav-link" href="/admin/setting/content">{{{ trans('admin.course_settings') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/setting/term">{{{ trans('admin.rules') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/setting/blog">{{{ trans('admin.blog_article_settings') }}}</a>
         </li>
         <li><a class="nav-link" href="/admin/setting/notification">{{{ trans('admin.notification_settings') }}}</a>
         </li>
         ...
         <li><a class="nav-link" href="/admin/setting/default">{{{ trans('admin.default_placeholders') }}}</a>
         </li>
        </ul>
       </li>@endif
       <li>
     ...
     <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="dropdown" id="mfs">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-life-ring"></i> <span>My
          Feedback / Support</span></a>
        <ul class="dropdown-menu">
         <li><a class="nav-link" href="/admin/ticket/new">{{{ trans('admin.submit_ticket') }}}</a></li>
        </ul>
       </li>
