      ...
      @if(checkAccess('content'))<li class="dropdown" id="content">
       ...
       <ul class="dropdown-menu">
        ...
        <li><a
          ...
          href="/admin/content/waiting">{{{ trans('admin.pending_courses') }}}</a></li>
        <li><a
          class="nav-link @if(isset($alert['content_draft']) && $alert['content_draft'] > 0) beep beep-sidebar @endif"
          href="/admin/content/draft">{{{ trans('admin.unpublished_courses') }}}</a></li>
      ...
      @if(checkAccess('channel'))<li class="dropdown" id="channel">
       ...
       <ul class="dropdown-menu">
        ...
        <li><a
          ...
          href="/admin/channel/request">{{{ trans('admin.verification_requests') }}}</a></li>
       </ul>
      </li>@endif
      ...
      @if(checkAccess('balance'))<li class="dropdown" id="balance">
       ...
       <ul class="dropdown-menu">
        ...
        <li><a class="nav-link @if(isset($alert['withdraw']) && $alert['withdraw'] > 0) beep beep-sidebar @endif"
          href="/admin/balance/withdraw">{{{ trans('admin.withdrawal_list') }}}</a></li>
    ...
    <aside id="sidebar-wrapper">
     ...
     <ul class="sidebar-menu">
      ...
      <li class="dropdown" id="mc">
       <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-play-circle"></i>
        <span>Course</span></a>
       <ul class="dropdown-menu">
      ...
      <li class="dropdown" id="rq">
       ...
       <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-camera"></i> <span>Request
         Course</span></a>
       <ul class="dropdown-menu">
      ...
      <li id="mb">
       <a href="/admin/user_balance/mybalance" class="nav-link"><i class="fas fa-dollar-sign"></i> <span>My
         Balance</span></a>
      </li>

      <li id="ma">
       <a href="/admin/user_dashboard/user" class="nav-link"><i class="fas fa-award"></i> <span>My
         Achievements</span></a>
      </li>

      <li class="dropdown" id="mfs">
       <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-comments"></i> <span>My
      ...
      <li class="dropdown" id="vc">
       <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-camera"></i> <span>Vendor
         Course</span></a>
       <ul class="dropdown-menu">
      ...
      <li id="ma">
       <a href="/admin/user_vendor/vendor" class="nav-link"><i class="fas fa-chalkboard-teacher"></i> <span>Become A
         Vendor</span></a>
      </li>
