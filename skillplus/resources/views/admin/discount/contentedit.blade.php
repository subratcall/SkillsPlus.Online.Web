                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="date" id="fsdate" value="{{{ date('Y/m/d',$discount->first_date) }}}" class="text-center form-control" name="fsdate" placeholder="Start Date">
                                    <input type="hidden" id="fdate" value="{{{ date('Y-m-d',$discount->first_date) }}}" name="fdate" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="date" id="lsdate" class="text-center form-control" value="{{{ date('Y/m/d',$discount->last_date) }}}" name="lsdate" placeholder="End Date">
                                    <input type="hidden" id="ldate" name="ldate" value="{{{ date('Y-m-d',$discount->last_date) }}}" required>
