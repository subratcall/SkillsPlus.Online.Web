...
if(!isset($_SESSION["kc_disable"]))
    $_SESSION["kc_disable"] = true;

if (!file_exists($cycle['/bin/'.$_SESSION["kc_uploadedir"].'/'])) {
    mkdir('/bin/'.$_SESSION["kc_uploadedir"], 0777, true);
}
...
define('USE_ACCESS_KEYS', $_SESSION["kc_disable"]); // TRUE or FALSE
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/bin/'.$_SESSION["kc_uploadedir"].'/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../bin/'.$_SESSION["kc_uploadedir"].'/',
