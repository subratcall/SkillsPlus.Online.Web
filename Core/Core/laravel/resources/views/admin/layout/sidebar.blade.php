            ...
            <div class="nano-content">
                <nav id="menu" class="nav-main" role="navigation">
                    <ul class="nav nav-main">
                        @if(checkAccess('report'))<li class="nav-parent {!! expandSidebarMenu('report',$capatibility) !!}" id="report">
                            <a>
                        ...
                        @if(checkAccess('user'))<li class="nav-parent {!! expandSidebarMenu('user',$capatibility) !!}" id="user">
                        <a>
                        ...
                        @if(checkAccess('channel'))<li class="nav-parent {!! expandSidebarMenu('channel',$capatibility) !!}" id="chanel">
                        <a>
                        ...
                        @if(checkAccess('content'))<li class="nav-parent {!! expandSidebarMenu('content',$capatibility) !!}" id="content">
                        <a>
                        ...
                        @if(checkAccess('balance'))<li class="nav-parent {!! expandSidebarMenu('balance',$capatibility) !!}" id="balance">
                        <a>
                        ...
                        @if(checkAccess('buysell'))<li class="nav-parent {!! expandSidebarMenu('buysell',$capatibility) !!}" id="balance">
                        <a>
                        ...
                        @if(checkAccess('manager'))<li class="nav-parent {!! expandSidebarMenu('manager',$capatibility) !!}" id="manager">
                        <a>
                        ...
                        @if(checkAccess('request'))<li class="nav-parent {!! expandSidebarMenu('request',$capatibility) !!}" id="request">
                        <a>
                        ...
                        @if(checkAccess('ads'))<li class="nav-parent {!! expandSidebarMenu('ads',$capatibility) !!}" id="manager">
                        <a>
                        ...
                        @if(checkAccess('blog'))<li class="nav-parent {!! expandSidebarMenu('blog',$capatibility) !!}" id="blog">
                        <a>
                        ...
                        @if(checkAccess('ticket'))<li class="nav-parent {!! expandSidebarMenu('ticket',$capatibility) !!}" id="ticket">
                        <a>
                        ...
                        @if(checkAccess('notification'))<li class="nav-parent {!! expandSidebarMenu('notification',$capatibility) !!}" id="notification">
                        <a>
                        ...
                        @if(checkAccess('email'))<li class="nav-parent {!! expandSidebarMenu('email',$capatibility) !!}" id="email">
                        <a>
                        ...
                        @if(checkAccess('discount'))<li class="nav-parent {!! expandSidebarMenu('discount',$capatibility) !!}" id="discount">
                        <a>
                        ...
                        @if(checkAccess('setting'))<li class="nav-parent {!! expandSidebarMenu('setting',$capatibility) !!}" id="setting">
