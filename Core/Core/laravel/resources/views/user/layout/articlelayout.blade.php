    ...
    <div class="container">
        <div class="col-md-12 col-xs-12">
            <ul class="nav nav-tabs nav-justified panel-tabs" role="tablist">
                <li class="@yield('tab1')"><a href="/user/article/new" id="newarticle">
                        <span class="submicon mdi mdi-book-plus"></span>
                       {{{ trans('main.new_article') }}}</a></li>
                <li class="@yield('tab2')"><a href="/user/article/list">
                        <span class="submicon mdi mdi-book"></span>
                        {{{ trans('main.my_articles') }}}</a></li>
            </ul>
