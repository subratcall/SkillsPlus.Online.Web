...
$(window).load(function(){
    ...
    $('#header-menu-section').on('sticky-start', function() { $('.menu-logo').fadeIn(300); });
    $('#header-menu-section').on('sticky-end', function() { $('.menu-logo').fadeOut(100); });
});

function openKCFinder(field) {
    var rand = Math.random().toString(36).substring(7);
    $(field).attr('id',rand);
    $('#uploader-modal iframe').attr('src','/assets/filemanager/dialog.php?type=2&field_id='+rand);
